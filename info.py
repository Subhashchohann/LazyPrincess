...
auth_channel = environ.get('-1001957925597')
auth_grp = environ.get('1141965474')
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'File Store Chennal')

# Others
LOG_CHANNEL = int(environ.get('-1001957925597', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'subhashchohan07')
...
CAPTION_BUTTON_URL = "https://t.me/+331eh4-CuVQ0MWI1"
